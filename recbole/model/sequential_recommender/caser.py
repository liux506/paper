...
class Caser(SequentialRecommender):
    ...
    Note:
        ...
        In addition, to prevent excessive CNN layer (ValueError: Training loss is nan), please make sure the parameters MAX_ITEM_LIST_LENGTH small, such as 10.
    """
    ...
    def forward(self, user, item_seq):
        # Embedding Look-up
        # use unsqueeze() to get a 4-D input for convolution layer. (batch_size * 1 * max_length * embedding_size)
